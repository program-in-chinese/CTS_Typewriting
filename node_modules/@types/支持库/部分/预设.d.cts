...
接口 预设构造函数类 {
     ...
     */
    //@@{ 执行者:executor, 成功:resolve, 值:value, 预设连接类:PromiseLike, 失败:reject, 原因:reason, 预设类:Promise }
     ...
     */
    //@@{ 所有:all, 值:value, 预设连接类:PromiseLike, 预设类:Promise }
     ...
     * @returns A new Promise.
     */
    //@@{ 值:value, 预设连接类:PromiseLike, 预设类:Promise }
     ...
     * @returns A new Promise.
     */
    //@@{ 竞速:race, 值:value, 预设连接类:PromiseLike, 预设类:Promise }
     ...
     */
    //@@{ 失败:reject, 原因:reason, 预设类:Promise }
    失败(原因: 任意): 预设类<不及>;
    /**
     * Creates a new rejected promise for the provided reason.
     * @param 原因 The reason the promise was rejected.
     ...
     */
    //@@{ 成功:resolve, 值:value, 预设连接类:PromiseLike, 预设类:Promise }
...
//@@{ 预设类:Promise, 预设构造函数类:PromiseConstructor }
声明 值量 预设类: 预设构造函数类;
