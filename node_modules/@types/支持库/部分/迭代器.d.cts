...
//@@{ 迭代器结果类:IteratorResult, 完成:done, 值:value }
接口 迭代器结果类<T> {
    完成: 真假;
    值: T;
}
//@@{ 迭代器类:Iterator, 下个:next, 值:value, 返回:return, 值:value, 抛出:throw, _错误:e }
接口 迭代器类<T> {
    下个(值?: 任意): 迭代器结果类<T>;
    返回?(值?: 任意): 迭代器结果类<T>;
    抛出?(_错误?: 任意): 迭代器结果类<T>;
...
接口 数组构造函数类 {
     ...
     */
    //@@{ 从连接:from }
    //@@{ 可迭代:iterable, 映射函数:mapfn, 值:v, 键:k, 本体参数:thisArg }
...
//@@{ 映射类:Map }
//@@{ 映射构造函数类:MapConstructor, 可迭代:iterable }
接口 映射构造函数类 {
    新建 <K, V>(可迭代: 可迭代类<[K, V]>): 映射类<K, V>;
}
接口 弱映射类<K 扩展 实例, V> {
}
//@@{ 弱映射构造函数类:WeakMapConstructor, 可迭代:iterable }
接口 弱映射构造函数类 {
...
//@@{ 集合构造函数类:SetConstructor, 可迭代:iterable }
接口 集合构造函数类 {
...
//@@{ 弱集合构造函数类:WeakSetConstructor, 可迭代:iterable }
接口 弱集合构造函数类 {
...
//@@{ 元素集:elements, 数组连接:arrayLike, 映射函数:mapfn, 值:v, 键:k, 本体参数:thisArg }
接口 整数8数组构造函数类 {
